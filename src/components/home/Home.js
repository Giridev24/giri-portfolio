...
export default function Home({innerRef}) {
   ...
   return (
      <Box ref={innerRef} component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box className={classNames(Style.avatar, Style.shadowed)} alt={'image of developer'} style={{background: info.gradient}} component={'img'} src={me} width={{xs: '9vh', md: '19vh'}}
              height={{xs: '10vh', md: '20vh'}}
              borderRadius={'38%'} p={'0.4rem'} mb={{xs: '1rem', sm: '1rem'}} mr={{xs: 0, md: '4rem'}}/>
         <Box>
